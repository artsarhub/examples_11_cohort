...
func main() {
	...
	//fmt.Println(functions.GetSumOfAnyArgs(1, 2, 3))
	...
	//fmt.Println(functions.IsEqual(1, 2))
	//fmt.Println(functions.Validate("login", functions.ValidateLogin))
	//fmt.Println(functions.Validate("pass", functions.ValidatePassword))
